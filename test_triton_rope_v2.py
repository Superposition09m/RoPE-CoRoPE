"""
Test script to verify Triton RoPE v2 fused Flash Attention against PyTorch baseline

This test compares the Triton v2 implementation (minimal change from flash v2) 
with the PyTorch reference implementation for both forward and backward passes.
"""

import torch
from rope_attn_pytorch import precompute_freqs_cis, attention_pytorch
from flash_attn_rope_v2_triton import attention as attention_triton
...
def test_rope_attention():
    ...
    print_separator()
    print("Triton RoPE v2 Fused Flash Attention - Correctness Test (Minimal Change)")
    print_separator()
